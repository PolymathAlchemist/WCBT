...
def test_verify_run_writes_report_on_failure_missing_file(tmp_path: Path) -> None:
    ...
    # Induce drift: remove a non-artifact payload file
    payload_files = [
        p
    ...
    assert payload_files, "Expected at least one archived payload file to exist"
    ...
    # Even on failure, artifacts should be written for inspection.
